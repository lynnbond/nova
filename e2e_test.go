...
func seedProcesses(t *testing.T, withConcur bool) string {
	...
	schema := []string{
		...
		`CREATE TABLE IF NOT EXISTS act_link (id TEXT PRIMARY KEY, seq INTEGER NOT NULL DEFAULT 0, pro_ver_id TEXT NOT NULL REFERENCES pro_ver(id), act_id TEXT NOT NULL REFERENCES act(id), prev_act_id TEXT NOT NULL, title TEXT NOT NULL DEFAULT '', link_type INTEGER NOT NULL DEFAULT 1);`,
